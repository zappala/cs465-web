...
- Understand the definition of computer security, what cybersecurity refers to,
  and how privacy may (or may not!) be different from security.
...
- Requires thinking carefully about security throughout a software project you
  are working on
