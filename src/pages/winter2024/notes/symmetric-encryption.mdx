...
- [Kerckhoffs's principle](https://en.wikipedia.org/wiki/Kerckhoffs%27s_principle), as restated by Steven Bellovin -- "design your system assuming that your opponents know it in detail"
...
- A keyspace of 56 bits provides 2 56 ≈ 7.2×10<sup>16</sup> possible keys. At a rate of
  10<sup>12</sup> keys per second it would take approximately 7.2×10<sup>4</sup> seconds or about 20
...
- AES is the most common block cipher -- [see Figure 2.3, page 34](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)
...
- For comparison:
  - 1 in 2<sup>61</sup> odds of winning the lottery and being hit by lightning in the same day
