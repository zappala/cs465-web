...
There are some group projects for this class. In those cases, you are encouraged
to work together. Please turn in a single assignment for your group. Put all of
your names on the assignment, and then we will be sure to get you all the same
grade.

Any assignment not marked as group work is designed for individual work. In this
case, you are welcome to discuss the assignment with other class members and how
to solve it, but you may not view, share, or copy another student's code.

### Exams

All exams are individual work. Follow the honor code and the instructions in the
exam.
...
- Copying code from online sources without crediting them. You are welcome to
  ...
  should not be searching for exact solutons online.
