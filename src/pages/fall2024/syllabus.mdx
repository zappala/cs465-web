...
This is the second semester of a redesign for CS 465. This new version of the
course gives a wider introduction to computer security than in the past and
tries to use only CS 224 as a prerequisite. I am hoping this course can become
accessible to sophomores.
