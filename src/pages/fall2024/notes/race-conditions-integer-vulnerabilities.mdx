...
- understand what it means to disable interrupts and why this is not a viable
  method on modern systems
- walking through unsuccessful approaches is useful to understanding offensive
  and defensive thinking
- understand the example in
  [Figure 6.2, page 159](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch6-rev1.pdf)
- understand the `/tmp` file exploits example

### Integer-based vulnerabilities

- due to integer bugs
- related to side-effects of types conversions between different integer types
  or signedness
...
- understand Example on _Integer overflow on multiplication_
- see
...
- understand pointer arithmetic and how that can be exploited by integer
  vulnerabilities
