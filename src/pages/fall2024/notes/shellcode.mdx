...
![basic buffer overflow, overwriting the return address with a pointer into the code block](/images/notes/basic-overflow.png)
...
![buffer overflow that injects code onto the stack](/images/notes/injecting-code.png)
