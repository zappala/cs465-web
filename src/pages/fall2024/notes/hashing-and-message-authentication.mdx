...
- You want to compute a digital signature of a hash. What attack can be stopped
  by a hash functon that has second preimage resistance? What attack can be
  stopped by a hash function that has collision resistance?

## Key concepts

### Cryptographic hash functions

- [Figure 2.10](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)
  shows a cryptographic hash function
...
- common cryptographic hash functions -- see
  [Table 2.1, page 44](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)
...
- Digital signatures
  ...
  - see
    [Figure 2.11, page 45](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)
...
- covers both integrity of the data and the identity of the party that sent the
  message
...
- see [Figure 2.12, page
  46)(https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)

- HMAC builds a MAC from a hash function, e.g. HMAC-SHA256

### Authenticated encryption

- _authenticated encryption_: provides both confidentiality and integrity
  (protecting against message modification and injection that an active attacker
  may try)
- _authenticated encryption with associated data_: provides additional
  associated data that is authenticated but not encrypted -- see
  [Figure 2.13, page 48](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)
- use a special algorithm -- see
  [Table 2.2, page 49](https://people.scs.carleton.ca/~paulv/toolsjewels/TJrev1/ch2-rev1.pdf)
  -- typically AEAD_AES_128_GCM
