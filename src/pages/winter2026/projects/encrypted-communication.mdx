...
- Total (135 points)
  - 27 points for sending the server a valid Hello Message
  - 27 points for sending the server a valid Encrypted Message
  - 27 points for sending the server a symmetric encryption key that is
    encrypted with its public key.
  - 27 points for sending the server a message that is correctly encrypted with
    the symmetric key and nonce
  - 27 points for using a new encryption key and nonce with every Encrypted
    Message
...
Submit your tar file on Canvas.
