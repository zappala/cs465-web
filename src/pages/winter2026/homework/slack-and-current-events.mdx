...
Join the class slack channel.  Use your name so that we can match you up with the class roll.  This will get you access to help from the TA and Professor Clift.

Here is [a Slack invitation](https://join.slack.com/t/byucs465winter2026/shared_invite/zt-3mslclyl2-b1poczTIL0q~iWOVGSNcXw)
...
Post according to the following schedule, based on the first letter of your last name.
